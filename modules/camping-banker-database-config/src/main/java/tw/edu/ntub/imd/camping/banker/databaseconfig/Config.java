package tw.edu.ntub.imd.camping.banker.databaseconfig;
...
@EnableJpaRepositories(basePackages = "tw.edu.ntub.imd.camping.banker.databaseconfig.dao")
@EnableTransactionManagement
@EntityScan(basePackages = "tw.edu.ntub.imd.camping.banker.databaseconfig.entity")
public class Config {
    public static final String DATABASE_NAME = "camping-banker";
